...
> 
```sh
cd netflix-ui-design
https://github.com/anyars-encarta/netflix-ui-design.git
```
...
- [ ] **Implement backend of the application**
...
- **What new features should be expected in the next release of the project?**
  ...
  - I am currently working on the backend of the app and adding functionalities to the design.
